...
import { ArrowRight, Database, FileText, Mail, ShieldCheck, Timer } from "lucide-react";
...
export const metadata: Metadata = {
  title: "Politique de confidentialité — TechPulse",
  description:
    "Quelles données TechPulse Magazine traite lorsque vous lisez nos stories ou vous connectez, combien de temps elles sont conservées et comment exercer vos droits.",
};

const SECTIONS = [
  { icon: Database, headingKey: "privacy.dataHeading", bodyKey: "privacy.dataBody" },
  { icon: ShieldCheck, headingKey: "privacy.cookiesHeading", bodyKey: "privacy.cookiesBody" },
  { icon: Timer, headingKey: "privacy.retentionHeading", bodyKey: "privacy.retentionBody" },
  { icon: FileText, headingKey: "privacy.rightsHeading", bodyKey: "privacy.rightsBody" },
] as const;

/**
 * Privacy page — `/privacy`.
 *
 * The real target of the dashboard's "Politique de confidentialité" row (it
 * used to point at a route that did not exist) and of the footer's policy
 * link. Server component on the shared 1200px editorial measure; every string
 * is translated through the `<T />` leaf so the page follows the reader's
 * locale without becoming a client component.
 */
  ...
  return (
    <div className="flex min-h-full flex-col">
      ...
      <main className="mx-auto w-full max-w-[1200px] flex-1 px-4 py-12">
        ...
        <section aria-labelledby="privacy-details-heading" className="mt-12 flex flex-col gap-6">
          <h2
            id="privacy-details-heading"
            className="text-2xl font-semibold tracking-tight text-foreground sm:text-3xl"
          >
            <T k="privacy.dataHeading" />
          </h2>
        ...
        >
          ...
          <h2
            ...
            className="text-2xl font-semibold tracking-tight text-foreground sm:text-3xl"
          >
            <T k="privacy.contactHeading" />
          </h2>
          <p className="mx-auto max-w-xl text-sm leading-relaxed text-muted-foreground">
            <T k="privacy.contactBody" />
          </p>
